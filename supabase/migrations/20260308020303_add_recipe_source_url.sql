-- Add source_url column to recipe table
ALTER TABLE "public"."recipe" ADD COLUMN "source_url" character varying;

-- Drop the old function signature to prevent duplicates
...
-- Update add_recipe function to include source_url parameter
CREATE OR REPLACE FUNCTION "public"."add_recipe"(
  ...
  begin
    ...
    values (add_recipe.recipe_id, add_recipe.name, add_recipe.description, add_recipe.number_of_servings, add_recipe.prep_time_hours, add_recipe.prep_time_minutes, add_recipe.cook_time_hours, add_recipe.cook_time_minutes, add_recipe.image_id, add_recipe.source_url, current_user_id) 
