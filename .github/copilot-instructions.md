...
- Never use `unknown` unless there is absolutely no alternative (this is very rare). If you must you `unknown` you must give a clear description as to why you couldn't create and use proper types.
